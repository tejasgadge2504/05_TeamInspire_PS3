...
try:
    ...
    with connection.cursor() as cursor:
        ...
        print('Successfully connected to MySQL server:', result)
...
def run():
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'team_inspire' and ad_password == 'team_inspire':
                st.success("Welcome Team inspire")
                # Display Data
